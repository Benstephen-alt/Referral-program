...
export default function AdminPanel() {
  ...
  return (
    <main className="page">
      ...
      <div className="admin-grid-3"><StatCard title="Manager" value={formatNumber(tiers.tier1)} subtext="$3 every 10 days" /><StatCard title="Controller" value={formatNumber(tiers.tier2)} subtext="$7 every 10 days • 12 referrals" /><StatCard title="Chief controller" value={formatNumber(tiers.tier3)} subtext="$11 every 10 days • 20 referrals" /></div>
