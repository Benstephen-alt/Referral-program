...
const referralRows = [
  ...
  { tier: "Chief Controller", requirement: "18 Referrals", reward: "$30", cycle: "Every 10 Days" },
];
      ...
      <section className="overview-grid" style={{ marginTop: 18 }}>
        ...
        <div className="overview-card">
          ...
          <div className="info-list">
            <div className="info-row"><span className="info-label">Eligibility</span><span className="info-value">Stake minimum $200 or have 20 referrals</span></div>
